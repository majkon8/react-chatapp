...
exports.updateLastActive = exports.deleteUserAccount = exports.updateUserAccountDetails = exports.refreshAccessToken = exports.externalLogin = exports.resetPassword = exports.forgotPassword = exports.confirmAccount = exports.login = exports.signup = exports.searchForUsers = exports.getAuthenticatedUser = exports.getUserById = void 0;
...
exports.getAuthenticatedUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var refreshToken, userId, user, error_2;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, user_model_1.User.findByIdAndRefreshToken(userId, refreshToken)];
            case 1:
                user = _b.sent();
                if (!user)
...
exports.searchForUsers = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var username, usernameRegex, users, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, user_model_1.User.findByUsername(usernameRegex)];
            case 1:
                users = _a.sent();
...
exports.signup = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var body, newUser, mailOptions, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                ...
                return [4 /*yield*/, newUser.createTokens()];
            case 1:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, user_model_1.User.findByIdAndTemporaryToken(decodedToken_1._id, temporaryToken)];
            case 1:
                user = _a.sent();
                if (!user)
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, user_model_1.User.findByIdAndTemporaryToken(decodedToken_2._id, temporaryToken)];
            case 1:
                user = _a.sent();
                if (!user)
                    return [2 /*return*/, res.status(404).json({ error: "User not found" })];
...
exports.externalLogin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var body, user, newUser, createdUser, accessToken, refreshToken, accessToken, error_9;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 8, , 9]);
            ...
            case 4:
                ...
                return [2 /*return*/, res.json("success")];
            case 5:
                if (!(user && user.createdExternally)) return [3 /*break*/, 7];
                refreshToken = user.refreshToken;
                return [4 /*yield*/, user.generateToken(true)];
            case 6:
                accessToken = _a.sent();
...
exports.updateUserAccountDetails = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, bio, username, imageUrl, oldUser, newUser, error_10;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
            ...
            case 1:
                oldUser = _a.sent();
                return [4 /*yield*/, user_model_1.User.updateUserAccountDetails(userId, bio, username, imageUrl)];
            case 2:
                newUser = _a.sent();
                return [4 /*yield*/, conversation_model_1.Conversation.changeUsernameInConversations(userId, oldUser.username, newUser.username)];
            case 3:
                _a.sent();
            ...
            case 4:
                ...
                return [2 /*return*/, res.status(400).json(error_10)];
            case 5: return [2 /*return*/];
        }
    });
}); };
// DELETE USER ACCOUNT
exports.deleteUserAccount = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, error_11;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                ...
                return [2 /*return*/, res.status(400).json(error_11)];
            case 3: return [2 /*return*/];
        }
    });
}); };
// UPDATE LAST ACTIVE
exports.updateLastActive = function (userId, lastActive) { return __awaiter(void 0, void 0, void 0, function () {
    var error_12;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, user_model_1.User.updateLastActive(userId, lastActive)];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:

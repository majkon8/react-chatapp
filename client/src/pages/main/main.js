...
var mapActionsToProps = { getAuthenticatedUser: userActions_1.getAuthenticatedUser, updateLastActive: dataActions_1.updateLastActive };
var connector = react_redux_1.connect(mapStateToProps, mapActionsToProps);
function Main(_a) {
    var _b;
    var UI = _a.UI, user = _a.user, data = _a.data, getAuthenticatedUser = _a.getAuthenticatedUser, updateLastActive = _a.updateLastActive;
    ...
    react_1.useEffect(function () {
        socket === null || socket === void 0 ? void 0 : socket.on("lastActive", function (userId, lastActive) {
            updateLastActive(userId, lastActive);
        });
        return function () {
            socket === null || socket === void 0 ? void 0 : socket.off("lastActive");
        };
    }, [socket, user.authenticatedUser]);
    react_1.useEffect(function () {
        if (!user.accessToken)

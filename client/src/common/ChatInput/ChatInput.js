...
function ChatInput(_a) {
    var type = _a.type, value = _a.value, handleChange = _a.handleChange;
    var inputMarkup = type === "search" ? (react_1.default.createElement("div", { className: "control has-icons-left" },

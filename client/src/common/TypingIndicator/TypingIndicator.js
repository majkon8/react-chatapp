...
function TypingIndicator(_a) {
    var showImage = _a.showImage, changeBackgroundColor = _a.changeBackgroundColor;
    return (react_1.default.createElement("div", { className: "typing-indicator-container" },
        showImage && (react_1.default.createElement("img", { className: "typing-indicator-user-image", src: "https://socialape-98946.firebaseapp.com/static/media/no-image.5a021ab9.png", alt: "user" })),

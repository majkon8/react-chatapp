...
exports.updateLastActive = function (userId, lastActive) { return function (dispatch) { return dispatch({ type: types_1.UPDATE_LAST_ACTIVE, payload: { userId: userId, lastActive: lastActive } }); }; };

...
function default_1(state, action) {
    ...
    switch (action.type) {
        ...
        case types_1.UPDATE_USER_ACCOUNT_DETAILS:
            return __assign(__assign({}, state), { authenticatedUser: __assign(__assign({}, state.authenticatedUser), { bio: action.payload.bio, username: action.payload.username, imageUrl: action.payload.imageUrl }) });
        default:
            return state;
    }
}

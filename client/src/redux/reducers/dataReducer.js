...
function default_1(state, action) {
    ...
    switch (action.type) {
            ...
            if (isNewConversation) {
                return __assign(__assign({}, state), { 
                    ...
                    searchedUsers: state.searchedUsers
                        ? state.searchedUsers.filter(function (user) {
                            var _a;
                            if (isSender_1)
        ...
        case types_1.DISPLAY_MESSAGE:
            return __assign(__assign({}, state), { conversations: (_f = state.conversations) === null || _f === void 0 ? void 0 : _f.map(function (conversation) {
                    if (conversation._id === action.payload._id)
                        conversation.isDisplayed = true;
                    return conversation;
                }) });
        case types_1.SET_MESSAGE_DELETED:
            return __assign(__assign({}, state), { messages: (_g = state.messages) === null || _g === void 0 ? void 0 : _g.map(function (message) {
                    ...
                    return message;
                }), conversations: (_h = state.conversations) === null || _h === void 0 ? void 0 : _h.map(function (conversation) {
        ...
        case types_1.DELETE_CONVERSATION:
            ...
            return __assign(__assign({}, state), { conversations: (_k = state.conversations) === null || _k === void 0 ? void 0 : _k.filter(function (conversation) { return conversation._id !== action.payload; }), selectedConversation: isDeletingSelectedConversation
                    ? null
        ...
        case types_1.ADD_REACTION_EMOTE_TO_MESSAGE:
            return __assign(__assign({}, state), { messages: (_l = state.messages) === null || _l === void 0 ? void 0 : _l.map(function (message) {
        ...
        case types_1.UPDATE_LAST_ACTIVE:
            return __assign(__assign({}, state), { conversations: (_m = state.conversations) === null || _m === void 0 ? void 0 : _m.map(function (conversation) {
                    if (conversation.user._id === action.payload.userId)
                        conversation.user.lastActive = action.payload.lastActive;
                    return conversation;
                }), selectedConversation: ((_o = state.selectedConversation) === null || _o === void 0 ? void 0 : _o.userId) === action.payload.userId
                    ? __assign(__assign({}, state.selectedConversation), { lastActive: action.payload.lastActive }) : state.selectedConversation });
        default:
            return state;
    }
}

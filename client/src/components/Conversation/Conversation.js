...
function Conversation(_a) {
    ...
    return (react_1.default.createElement("div", { onClick: handleClick, className: "conversation-container " + (isActive && "active-conversation") },
        ...
        react_1.default.createElement("img", { src: userImageUrl
                ? userImageUrl
                : "https://socialape-98946.firebaseapp.com/static/media/no-image.5a021ab9.png", alt: "user" }),
        lastActive === "now" && (react_1.default.createElement("div", { className: "conversation-is-active-indicator has-background-success " + (isActive && "active-conversation-is-active-indicator") })),
        react_1.default.createElement("div", { className: "title-message-container" },
            ...
            isTyping && react_1.default.createElement(TypingIndicator_1.default, { changeBackgroundColor: true }))));
}

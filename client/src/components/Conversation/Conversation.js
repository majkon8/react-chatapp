...
function Conversation(_a) {
    var isActive = _a.isActive, isNew = _a.isNew, username = _a.username, userId = _a.userId, id = _a.id, messageBody = _a.messageBody, isTyping = _a.isTyping, type = _a.type, file = _a.file, createdAt = _a.createdAt, isDisplayed = _a.isDisplayed, handleActive = _a.handleActive, setIsChatOpen = _a.setIsChatOpen, setSelectedConversation = _a.setSelectedConversation, getMessages = _a.getMessages, deleteConversation = _a.deleteConversation;
    ...
    var isMessageDeleted = type === "text" && messageBody === "";
    ...
    return (react_1.default.createElement("div", { onClick: handleClick, className: "conversation-container " + (isActive && "active-conversation") },
        !isNew && (react_1.default.createElement("div", { onClick: function (e) { return handleConversationDelete(e); }, className: "conversation-delete" },
        ...
        react_1.default.createElement("div", { className: "title-message-container" },
            ...
            !isNew && createdAt && !isTyping && (react_1.default.createElement("span", { className: isDisplayed
                    ? "conversation-message"
                    : "conversation-message-not-displayed" },
                !isMessageDeleted && (messageBody ? messageBody : file === null || file === void 0 ? void 0 : file.name),
            ...
            isTyping && react_1.default.createElement(TypingIndicator_1.default, null))));
}

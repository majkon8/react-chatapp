...
function Reply(_a) {
    ...
    return (react_1.default.createElement("div", { title: "Reply", className: "reply-trigger-container " + (isOwnMessage ? "own-message-reply" : "other-message-reply") },
        react_1.default.createElement("button", { onClick: handleReply, className: "action-trigger" },

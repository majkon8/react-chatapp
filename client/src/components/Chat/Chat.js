...
function Chat(_a) {
    ...
    return (react_1.default.createElement("div", { className: "chat-container" },
        ...
        , { 
            ...
            var _a;
            return (react_1.default.createElement(Message_1.default, { key: message._id, isOwnMessage: message.authorId === ((_a = user.authenticatedUser) === null || _a === void 0 ? void 0 : _a._id), body: message.body, file: message.file, type: message.type, createdAt: message.createdAt, isLast: index === data.messages.length - 1 }));
        }))),

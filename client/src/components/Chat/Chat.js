...
var mapActionsToProps = { setNewMessage: dataActions_1.setNewMessage, getMessages: dataActions_1.getMessages, setMessageDeleted: dataActions_1.setMessageDeleted };
var connector = react_redux_1.connect(mapStateToProps, mapActionsToProps);
function Chat(_a) {
    var _b;
    var socket = _a.socket, UI = _a.UI, data = _a.data, user = _a.user, isTyping = _a.isTyping, setNewMessage = _a.setNewMessage, getMessages = _a.getMessages, setMessageDeleted = _a.setMessageDeleted;
    ...
    return (react_1.default.createElement("div", { className: "chat-container" },
        ...
        , { 
            // @ts-ignore
            ref: scrollRef, onScroll: handleScroll, style: { maxHeight: "calc(100vh - 170px)" } },
            UI.pending.messages ? (react_1.default.createElement(core_1.CircularProgress, { color: "inherit" })) : ((_b = data.messages) === null || _b === void 0 ? void 0 : _b.map(function (message, index) {
                var _a;
                return (react_1.default.createElement(Message_1.default, { key: message._id, isOwnMessage: message.authorId === ((_a = user.authenticatedUser) === null || _a === void 0 ? void 0 : _a._id), messageId: message._id, body: message.body, file: message.file, type: message.type, createdAt: message.createdAt, isLast: index === data.messages.length - 1, socket: socket }));
            })),

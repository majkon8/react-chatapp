...
var mapActionsToProps = {
    setNewMessage: dataActions_1.setNewMessage,
    getMoreMessages: dataActions_1.getMoreMessages,
    setMessageDeleted: dataActions_1.setMessageDeleted,
};
var connector = react_redux_1.connect(mapStateToProps, mapActionsToProps);
function Chat(_a) {
    var _b, _c;
    var socket = _a.socket, UI = _a.UI, data = _a.data, user = _a.user, isTyping = _a.isTyping, setNewMessage = _a.setNewMessage, getMoreMessages = _a.getMoreMessages, setMessageDeleted = _a.setMessageDeleted;
    var _d = __read(react_1.useState(false), 2), isScrolling = _d[0], setIsScrolling = _d[1];
    var _e = __read(react_1.useState(2), 2), page = _e[0], setPage = _e[1];
    ...
    react_1.useEffect(function () {
        socket === null || socket === void 0 ? void 0 : socket.on("receiveMessage", function (message) {
            ...
            var messageData = {
                ...
                messageConversation: __assign(__assign({}, message.messageConversation), { user: conversationUser }),
            };
            setNewMessage(messageData);
        });
        socket === null || socket === void 0 ? void 0 : socket.on("messageDeleted", function (messageId) {
            return setMessageDeleted(messageId);
        });
        return function () {
            socket === null || socket === void 0 ? void 0 : socket.off("receiveMessage");
            socket === null || socket === void 0 ? void 0 : socket.off("messageDeleted");
        };
    ...
    return (react_1.default.createElement("div", { className: "chat-container" },
        ...
        , { 
            // @ts-ignore
            ref: scrollRef, onScroll: handleScroll, style: { maxHeight: "calc(100vh - 170px)" } }, (_b = data.messages) === null || _b === void 0 ? void 0 :
            _b.map(function (message, index) {
                var _a;
                return (react_1.default.createElement(Message_1.default, { key: message._id, isOwnMessage: message.authorId === ((_a = user.authenticatedUser) === null || _a === void 0 ? void 0 : _a._id), message: message, isLast: index === data.messages.length - 1, socket: socket }));
            }),
            UI.pending.messages && react_1.default.createElement(core_1.CircularProgress, { color: "inherit" }),
            isTyping && (react_1.default.createElement("div", { style: { marginBottom: 5 } },
                react_1.default.createElement(TypingIndicator_1.default, { imageUrl: (_c = data.selectedConversation) === null || _c === void 0 ? void 0 : _c.userImageUrl })))),

...
function Message(_a) {
    var isOwnMessage = _a.isOwnMessage, UI = _a.UI, data = _a.data, user = _a.user, body = _a.body, type = _a.type, file = _a.file, createdAt = _a.createdAt, isLast = _a.isLast;
    var textColor = [
        "rgb(127, 219, 255)",
        "rgb(1, 255, 112)",
        "rgb(255, 220, 0)",
    ...
    return (react_1.default.createElement("div", { className: "chat-message-container " + (isOwnMessage ? "own-chat-message" : "other-chat-message") },
        react_1.default.createElement("div", { className: "chat-message-content" },
            ...
            react_1.default.createElement("span", { style: {
                ...
                type === "image" && (react_1.default.createElement("img", { className: "media-small", src: file.url })),
                type === "video" && (react_1.default.createElement("video", { preload: "metadata", className: "video", controls: true },
                    react_1.default.createElement("source", { src: file.url + "#t=0", type: "video/mp4" }))))),

...
function Message(_a) {
    ...
    return (react_1.default.createElement("div", { className: "chat-message-container " + (isOwnMessage ? "own-chat-message" : "other-chat-message") },
        react_1.default.createElement("div", { className: "chat-message-content" },
            ...
            !isOwnMessage && (react_1.default.createElement("img", { className: "chat-message-user-image", src: ((_b = data.selectedConversation) === null || _b === void 0 ? void 0 : _b.userImageUrl) ? data.selectedConversation.userImageUrl
            ...
            shouldShowThatIsDisplayed() && (react_1.default.createElement("img", { style: {
                ...
                }, className: "is-displayed-indicator", src: ((_c = data.selectedConversation) === null || _c === void 0 ? void 0 : _c.userImageUrl) ? data.selectedConversation.userImageUrl
                    : "https://socialape-98946.firebaseapp.com/static/media/no-image.5a021ab9.png", alt: "user" })),
            ...
            message.reactionEmote && (react_1.default.createElement("span", { className: "message-reaction-emote-container" }, message.reactionEmote))),

...
function Message(_a) {
    var isOwnMessage = _a.isOwnMessage, UI = _a.UI, data = _a.data, user = _a.user, message = _a.message, isLast = _a.isLast, socket = _a.socket, setImageUrlToOpen = _a.setImageUrlToOpen;
    ...
    var openFullImage = function () { return setImageUrlToOpen(message.file.url); };
    ...
    return (react_1.default.createElement("div", { className: "chat-message-container " + (isOwnMessage ? "own-chat-message" : "other-chat-message") },
        react_1.default.createElement("div", { className: "chat-message-content" },
            ...
            !isMessageDeleted && (react_1.default.createElement(Reply_1.default, { isOwnMessage: isOwnMessage, to: isOwnMessage
            ...
            react_1.default.createElement("span", { style: {
                ...
                !isMessageDeleted && (message === null || message === void 0 ? void 0 : message.replyData) && (react_1.default.createElement("div", { className: "chat-message-reply-data" },
                    react_1.default.createElement("span", null,
                        ...
                        ":"),
                    react_1.default.createElement("span", null, shorten(message.replyData.body)))),
                ...
                message.type === "image" && (react_1.default.createElement("img", { onClick: openFullImage, className: "image-small", src: message.file.url })),

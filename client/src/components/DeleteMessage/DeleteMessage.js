...
function DeleteMessage(_a) {
    ...
    var handleMessageDelete = function () {
        var confirmed = confirm("Are you sure you want to delete the message? It will be deleted for both users in this conversation. This process is irreversible.");
        if (confirmed)
            socket === null || socket === void 0 ? void 0 : socket.emit("deleteMessage", {
                messageId: messageId,

...
function ChatSearch(_a) {
    ...
    return (react_1.default.createElement("div", { className: "chat-search-container " + (UI.isChatOpen && "is-closed") },
        react_1.default.createElement(ChatInput_1.default, { handleChange: function (e) { return handleChange(e); }, debounce: true, icon: "fa fa-search", placeholder: "Search for users..." })));
}

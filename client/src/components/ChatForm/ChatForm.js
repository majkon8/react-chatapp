...
function ChatForm(_a) {
    ...
    return (react_1.default.createElement("form", { className: "chat-form-container", onSubmit: submitChatMessage },
        react_1.default.createElement("div", { className: "file-container" },
            ...
            fileName ? (react_1.default.createElement("button", { onClick: function (e) { return handleFileRemove(e); }, className: "button is-rounded remove-button", title: "Remove file" },
            ...
            data.replyData && (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("button", { onClick: function (e) { return resetReplyData(e); }, className: "button is-rounded remove-button", title: "Cancel reply" },

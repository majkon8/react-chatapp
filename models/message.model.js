...
MessageSchema.statics.toggleMessageReactionEmote = function (messageId, emote) {
    return __awaiter(this, void 0, void 0, function () {
        var Message, message;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    Message = this;
                    return [4 /*yield*/, Message.findById(messageId)];
                case 1:
                    message = _a.sent();
                    if (!message.body && !message.file)
                        return [2 /*return*/, ""]; // message is deleted
                    if (message.reactionEmote === emote)
                        message.reactionEmote = "";
                    else
                        message.reactionEmote = emote;
                    message.save();
                    return [2 /*return*/, message.reactionEmote];
            }
        });
    });
};
